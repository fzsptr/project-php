    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=role&fitur=edit&id=<?php echo $role->roleId?>" method="POST">
                    <!-- Nama Role -->
                    <div class="mb-4">
                        ...
                        value="<?php echo htmlspecialchars($role->roleName)?>">
                    </div>
                    <!-- Role Deskripsi -->
                    <div class="mb-4">
                        ...
                        ><?php echo htmlspecialchars($role->roleDescription)?></textarea>
                    </div>
                    <!-- Role Status -->
                    <div class="mb-4">
                        ...
                        <select id="role_status" name="role_status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            ...
                            <option value=1 <?php echo $role->roleStatus == 1 ? 'selected' : ''; ?>>Active</option>
                            <option value=0 <?php echo $role->roleStatus == 0 ? 'selected' : ''; ?>>Inactive</option>
                        </select>
                    </div>
                    <!-- Submit Button -->
