<div class="w-64 bg-blue-200 text-black-100 h-screen">
    <div class="p-4 font-bold text-lg">Menu</div>
    <ul class="mt-4 space-y-2">
        <li class="group">
            <div class="px-4 py-2 hover:bg-gray-700 cursor-pointer group-hover:bg-gray-400">
...
<!--            </ul>-->
        ...
        <li class="group">
            <div class="px-4 py-2 hover:bg-gray-700 cursor-pointer group-hover:bg-gray-400">Menu Transaksi</div>
            <ul class="ml-4 space-y-1 hidden group-hover:block">
