            ...
            <div class="bg-white shadow-md rounded my-6">
                <table class="min-w-full bg-white grid-cols-1">
                    ...
                    <tr class="text-center">
                        <td class="py-3 px-4 text-blue-600"><?php echo htmlspecialchars($role->roleId);?></td>
                        <td class="w-1/4 py-3 px-4"><?php echo htmlspecialchars($role->roleName);?></td>
                        <td class="w-1/3 py-3 px-4"><?php echo htmlspecialchars($role->roleDescription);?></td>
                        <td class="w-1/6 py-3 px-4"><?php echo htmlspecialchars($role->roleStatus);?></td>
                        <td class="w-1/6 py-3 px-4">
                            <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded mr-2">
                                <a href="index.php?modul=role&fitur=update&id=<?php echo htmlspecialchars($role->roleId); ?>">Update</a>
                            </button>
                            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded mr-2">
                                <a href="index.php?modul=role&fitur=delete&id=<?php echo htmlspecialchars($role->roleId); ?>">Delete</a>
                            </button>
                        </td>
                    </tr>
                    <?php } ?>
