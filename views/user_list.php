            ...
            <div class="bg-white shadow-md rounded my-6">
                <table class="min-w-full bg-white grid-cols-1">
                    ...
                    <tr class="text-center border-b border-gray-200 pb-1">
                        <td class="py-3 px-4 text-blue-600"><?php echo htmlspecialchars($user->userId);?></td>
                        ...
                        <td class="w-1/6 py-3 px-4"><?php echo htmlspecialchars($user->role->roleName);?></td>
                        <td class="w-1/6 py-3 px-4">
                            <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded mr-2">
                                <a href="index.php?modul=user&fitur=update&id=<?php echo htmlspecialchars($user->userId); ?>">Update</a>
                            </button>
                            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded mr-2">
                                <a href="index.php?modul=user&fitur=delete&id=<?php echo htmlspecialchars($user->userId); ?>">Delete</a>
                            </button>
                        </td>
                    </tr>
                    <?php } ?>
